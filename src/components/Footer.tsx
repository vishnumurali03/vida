      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-6 mb-4">
            <h3 className="h3 text-success mb-3">Vida</h3>
            <p className="text-light mb-4">
              Your go-to platform for healthy, allergen-free recipes that don't compromise on taste.
              Discover, share, and enjoy cooking with confidence.
            </p>
          </div>
        ...
        <div className="text-center">
          <p className="text-muted mb-0">
            © 2024 Vida. All rights reserved. Made with ❤️ for healthy cooking.
          </p>
        </div>
      </div>
    </footer>
